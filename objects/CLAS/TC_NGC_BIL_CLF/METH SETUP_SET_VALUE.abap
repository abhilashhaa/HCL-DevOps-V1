    ...
    IF it_test_data IS NOT SUPPLIED.
      ...
      CASE iv_charcdatatype.
        WHEN if_ngc_c=>gc_charcdatatype-char.
          mo_ngc_classification->set_character_value( it_change_value = VALUE #( ) ).
        WHEN if_ngc_c=>gc_charcdatatype-num.
          mo_ngc_classification->set_numeric_value( it_change_value = VALUE #( ) ).
        WHEN if_ngc_c=>gc_charcdatatype-curr.
          mo_ngc_classification->set_currency_value( it_change_value = VALUE #( ) ).
        WHEN if_ngc_c=>gc_charcdatatype-date.
          mo_ngc_classification->set_numeric_value( it_change_value = VALUE #( ) ).
        WHEN if_ngc_c=>gc_charcdatatype-time.
          mo_ngc_classification->set_time_value( it_change_value = VALUE #( ) ).
        WHEN OTHERS.
      ENDCASE.
    ELSE.
      CASE iv_charcdatatype.
...
*          )->is_called_times( times = iv_number_of_expected_calling ).
          mo_ngc_classification->set_character_value( it_change_value = lt_char_change_value ).
        ...
        WHEN if_ngc_c=>gc_charcdatatype-num.
          ...
          mo_ngc_classification->set_numeric_value( it_change_value = lt_num_change_value ).
        ...
        WHEN if_ngc_c=>gc_charcdatatype-curr.
          ...
          mo_ngc_classification->set_currency_value( it_change_value = lt_curr_change_value ).
        ...
        WHEN if_ngc_c=>gc_charcdatatype-date.
          ...
          mo_ngc_classification->set_date_value( it_change_value = lt_date_change_value ).
        ...
        WHEN if_ngc_c=>gc_charcdatatype-time.
          ...
          mo_ngc_classification->set_time_value( it_change_value = lt_time_change_value ).
