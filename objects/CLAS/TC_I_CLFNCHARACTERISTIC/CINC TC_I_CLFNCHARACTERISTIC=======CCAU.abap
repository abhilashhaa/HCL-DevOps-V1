CLASS lth_test_data DEFINITION
  ...
  PUBLIC SECTION.
    ...
    CLASS-DATA:
      gs_charc_maintauthgrp_empty  TYPE i_clfncharcbasic,
      gs_charc_maintauthgrp_auth   TYPE i_clfncharcbasic,
      gs_charc_maintauthgrp_noauth TYPE i_clfncharcbasic.
...
CLASS ltc_i_clfncharacteristic_auth DEFINITION
  ...
  PRIVATE SECTION.
    ...
    METHODS:
      read_cds
        RETURNING
          VALUE(rt_result) TYPE ltt_i_clfncharacteristic,
...
CLASS ltc_i_clfncharacteristic_auth IMPLEMENTATION.
  ...
  METHOD class_setup.
    ...
    go_environment = cl_cds_test_environment=>create( 'I_ClfnCharacteristic' ).
  ...
  METHOD setup.
    ...
    DATA(lt_charcbasic) = VALUE ltt_i_clfncharcbasic(
    ...
    go_environment->insert_test_data( lt_charcbasic ).
  ...
  METHOD read_cds.
    ...
    SELECT * FROM i_clfncharacteristic
