  METHOD read_procparam_class_charcs.
    ...
    DATA(lv_body) = me->geturl(
      iv_uri         = 'A_RecProcParamValClassCharc?$top=10'
      iv_status_code = 200 ).
    ...
    me->geturl(
      iv_uri         = |A_RecProcParamValClassCharc?$filter=RecipeProcessParamValUUID eq guid'{ lv_recipeuuid }'|
      iv_status_code = 200 ).
