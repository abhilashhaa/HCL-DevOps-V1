  METHOD read_procparam_charc_values.
    ...
    DATA(lv_body) = me->geturl(
      iv_uri         = 'A_RecProcParamValCharcValue?$top=10'
      iv_status_code = 200 ).
    ...
    me->geturl(
      iv_uri         = |A_RecProcParamValCharcValue?$filter=RecipeProcessParamValUUID eq guid'{ lv_recipeuuid }'|
      iv_status_code = 200 ).
