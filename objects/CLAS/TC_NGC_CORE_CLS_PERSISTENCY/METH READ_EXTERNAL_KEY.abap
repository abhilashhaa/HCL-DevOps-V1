...
*--------------------------------------------------------------------*
    ...
    me->set_classes(
      it_class   = th_ngc_core_cls_pers_data=>get_classes_2018( )
      iv_keydate = th_ngc_core_cls_pers_data=>cv_keydate_2018 ).

    me->set_class_charcbasic( it_class_charcbasic = th_ngc_core_cls_pers_data=>get_class_charc_basic_2017( ) ).
    me->set_charcbasic( it_charcbasic = th_ngc_core_cls_pers_data=>get_charc_basic_2017( ) ).
    me->set_class_superior(
      it_class_superior = th_ngc_core_cls_pers_data=>get_class_superior_2017( )
      iv_keydate        = th_ngc_core_cls_pers_data=>cv_keydate_2017 ).

    me->set_class_charcbasic( it_class_charcbasic = th_ngc_core_cls_pers_data=>get_class_charc_basic_2018( ) ).
    me->set_charcbasic( it_charcbasic = th_ngc_core_cls_pers_data=>get_charc_basic_2018( ) ).
    me->set_class_superior(
      it_class_superior = th_ngc_core_cls_pers_data=>get_class_superior_2018( )
      iv_keydate        = th_ngc_core_cls_pers_data=>cv_keydate_2018 ).

    me->set_class_statuses( th_ngc_core_cls_pers_data=>get_class_statuses( ) ).

    me->get_class_data_external(
      EXPORTING
        it_class_with_keydate = VALUE #(
          ...
          ( classes = th_ngc_core_cls_pers_data=>get_classes_2018( ) keydate = th_ngc_core_cls_pers_data=>cv_keydate_2018 ) )
      IMPORTING
    ...
    me->get_class_charc_data(
      EXPORTING
        it_class_charc_with_kdate  = VALUE #(
          ( class_charcs = th_ngc_core_cls_pers_data=>get_class_charcs_2017( )   keydate = th_ngc_core_cls_pers_data=>cv_keydate_2017 )
          ( class_charcs = th_ngc_core_cls_pers_data=>get_class_charcs_2018( )   keydate = th_ngc_core_cls_pers_data=>cv_keydate_2018 ) )
      IMPORTING
    ...
    me->get_charc_value_data(
      EXPORTING
        it_class_charc_with_kdate = VALUE #(
          ( class_charcs = th_ngc_core_cls_pers_data=>get_class_charcs_2017( ) keydate = th_ngc_core_cls_pers_data=>cv_keydate_2017 )
          ( class_charcs = th_ngc_core_cls_pers_data=>get_class_charcs_2018( ) keydate = th_ngc_core_cls_pers_data=>cv_keydate_2018 ) )
        it_charc_value            = th_ngc_core_cls_pers_data=>get_charc_values( )
      IMPORTING
        et_charc_value_exp        = DATA(lt_charc_value_exp) ).

    me->get_charc_ref_data(
      EXPORTING
        it_charc_ref     = th_ngc_core_cls_pers_data=>get_charc_ref( )
      IMPORTING
...
*--------------------------------------------------------------------*
      ...
      me->assert_exp_charc_ref(
        it_act = lt_characteristic_reference
