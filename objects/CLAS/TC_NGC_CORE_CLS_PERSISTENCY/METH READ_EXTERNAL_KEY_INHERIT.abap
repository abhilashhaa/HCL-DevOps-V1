  METHOD read_external_key_inherit.
...
*--------------------------------------------------------------------*
    ...
    me->set_class_charcbasic( it_class_charcbasic = th_ngc_core_cls_pers_data=>get_class_charc_basic_inh_2017( ) ).
    me->set_charcbasic( it_charcbasic = th_ngc_core_cls_pers_data=>get_charc_basic_inh_2017( ) ).
    me->set_class_superior(
      it_class_superior = th_ngc_core_cls_pers_data=>get_class_superior_inh_2017( )
      iv_keydate        = th_ngc_core_cls_pers_data=>cv_keydate_2017 ).

    me->set_class_statuses( th_ngc_core_cls_pers_data=>get_class_statuses( ) ).
    me->set_charc_value( th_ngc_core_cls_pers_data=>get_charc_values_inherit_db( ) ).
    me->set_class_classification_basic( th_ngc_core_cls_pers_data=>get_class_classification_basic( ) ).
    ...
    me->get_class_charc_data(
      EXPORTING
        it_class_charc_with_kdate  = VALUE #(
          ( class_charcs = th_ngc_core_cls_pers_data=>get_class_charcs_inherit_2017( ) keydate = th_ngc_core_cls_pers_data=>cv_keydate_2017 ) )
      IMPORTING
    ...
    me->get_charc_value_data(
      EXPORTING
        it_class_charc_with_kdate    = VALUE #(
          ( class_charcs = th_ngc_core_cls_pers_data=>get_class_charcs_inherit_2017( ) keydate = th_ngc_core_cls_pers_data=>cv_keydate_2017 ) )
        it_charc_value               = th_ngc_core_cls_pers_data=>get_charc_values_inherit( )
        it_charc_value_inh_overwrite = th_ngc_core_cls_pers_data=>get_charc_values_inherit_db( )
      IMPORTING
