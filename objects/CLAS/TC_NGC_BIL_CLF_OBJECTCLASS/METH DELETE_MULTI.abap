  METHOD delete_multi.
    ...
    DATA:
      ...
      lt_test_data_temp     TYPE if_ngc_bil_clf=>ts_objclass-delete-t_input.

*--------------------------------------------------------------------*
* Arrangements
*--------------------------------------------------------------------*

    DATA(lt_test_data) = th_ngc_bil_clf_data=>gt_objectclass_delete_multi.
    ...
    setup_class_remove( iv_number_of_expected_calling = lines( lt_test_data_temp ) io_ngc_clf_api_result = lo_clf_api_result ).
