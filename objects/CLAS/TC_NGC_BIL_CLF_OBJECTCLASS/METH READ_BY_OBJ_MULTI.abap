...
*--------------------------------------------------------------------*
    ...
    DATA(lt_test_data) = th_ngc_bil_clf_data=>gt_objectclass_readb_multi_in.
...
*--------------------------------------------------------------------*
    ...
    cl_abap_unit_assert=>assert_equals(
      act = lt_result
      exp = th_ngc_bil_clf_data=>gt_objectclass_readb_multi_out
      msg = 'Result was not the expected' ).

    cl_abap_unit_assert=>assert_equals(
      act = lt_link
      exp = th_ngc_bil_clf_data=>gt_objectclass_readb_multi_l
      msg = 'Link was not the expected' ).
