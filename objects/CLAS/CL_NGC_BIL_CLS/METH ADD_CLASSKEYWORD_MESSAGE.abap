  METHOD add_classkeyword_message.
    ...
    <ls_reported>-classkeywordpositionnumber = iv_classkeywordpositionnumber.
    ...
    IF iv_set_failed = abap_true.
      ...
      <ls_failed>-classkeywordpositionnumber = iv_classkeywordpositionnumber.
