  METHOD if_ngc_bil_cls~create_class_keyword_direct.

    DATA:
      lt_create_from_class TYPE if_ngc_bil_cls_c=>lty_clfnclasskeywordtp-t_create.
    ...
    me->if_ngc_bil_cls~create_class_keyword(
      EXPORTING
