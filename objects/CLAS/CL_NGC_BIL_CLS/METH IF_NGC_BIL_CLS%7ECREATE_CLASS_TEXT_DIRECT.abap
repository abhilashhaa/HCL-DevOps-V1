  METHOD if_ngc_bil_cls~create_class_text_direct.

    DATA:
      lt_create_from_class TYPE if_ngc_bil_cls_c=>lty_clfnclasstexttp-t_create.
    ...
    me->if_ngc_bil_cls~create_class_text(
      EXPORTING
