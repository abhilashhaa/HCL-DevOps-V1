METHOD IF_DRF_OUTBOUND~INITIALIZE.
  ...
  CREATE OBJECT go_drf_chrmas.

  MOVE is_runtime_param TO go_drf_chrmas->ms_runtime_param.

  es_runtime_param_out_impl-table_type_name = if_ngc_drf_c=>gc_chrmas_drf_table_type.
  eo_if_drf_outbound = go_drf_chrmas.
