  METHOD call_badi_assign_classes.

    DATA:
      lo_clf_api_result     TYPE REF TO cl_ngc_clf_api_result,
      lo_badi               TYPE REF TO ngc_clf_check_assign_classes,
    ...
    LOOP AT mt_classtype ASSIGNING FIELD-SYMBOL(<ls_classtype>).
      ...
      TRY.
          ...
          TEST-SEAM badi_check_assign_classes.
            CALL BADI lo_badi->check_assign_classes
              EXPORTING
