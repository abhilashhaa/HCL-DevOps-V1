METHOD convert_client.
  ...
  IF mv_rework EQ abap_false.
    ...
    SELECT atinn FROM cabn CLIENT SPECIFIED
  ...
  IF mv_rework EQ abap_true OR lines( lt_atinn_first ) GT 0.
    ...
    MESSAGE i035(upgba) WITH 'Starting to update DATUB in table CABN. Client:' mv_client 'Time:' cl_ngc_core_data_conv=>get_current_time( ) INTO cl_upgba_logger=>mv_logmsg.
    ...
    TRY.
      ...
      MESSAGE i035(upgba) WITH 'Update finished for DATUB in CABN. Client:' mv_client 'Time:' cl_ngc_core_data_conv=>get_current_time( ) INTO cl_upgba_logger=>mv_logmsg.
