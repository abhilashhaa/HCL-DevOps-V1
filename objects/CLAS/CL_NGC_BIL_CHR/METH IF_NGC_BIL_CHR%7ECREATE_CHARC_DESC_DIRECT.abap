  METHOD if_ngc_bil_chr~create_charc_desc_direct.

    DATA:
      lt_create_from_charc TYPE if_ngc_bil_chr_c=>lty_clfncharcdesctp-t_create.
    ...
    me->if_ngc_bil_chr~create_charc_desc(
      EXPORTING
