  METHOD if_ngc_bil_chr~delete_charc_val_desc.
    ...
    LOOP AT it_delete ASSIGNING FIELD-SYMBOL(<ls_delete>).
      ...
      DATA(ls_charc_val) = VALUE #(
        <ls_change_data>-charcval[
          charcvaluepositionnumber = <ls_delete>-charcvaluepositionnumber ] OPTIONAL ).
      ...
      DATA(ls_charc_val_desc) = VALUE #(
        <ls_change_data>-charcvaldesc[
          value_char   = ls_charc_val-charcvalue
          language_int = <ls_delete>-language ] OPTIONAL ).
      ...
      ELSE.
        ...
        DELETE ls_change_data-charcvaldesc
          WHERE
            value_char   = ls_charc_val-charcvalue AND
