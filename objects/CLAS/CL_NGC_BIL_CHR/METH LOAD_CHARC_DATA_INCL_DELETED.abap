  METHOD load_charc_data_incl_deleted.
    ...
    DATA(ls_change_data) = VALUE #( mt_charc_change_data[ charc-charcinternalid = iv_charcinternalid changenumber = iv_changenumber ] OPTIONAL ).

    IF ls_change_data IS INITIAL.
      rv_new = abap_true.
