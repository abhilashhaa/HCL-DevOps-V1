  METHOD if_ngc_bil_chr~create_charc_val_desc_direct.

    DATA:
      lt_create_from_charc TYPE if_ngc_bil_chr_c=>lty_clfncharcvaldesctp-t_create.
    ...
    LOOP AT it_create INTO DATA(ls_create)
      GROUP BY
        ( charcinternalid          = ls_create-charcinternalid
          charcvaluepositionnumber = ls_create-charcvaluepositionnumber )
      ...
      <ls_create_from_charc>-charcvaluepositionnumber = ls_create_group->charcvaluepositionnumber.
    ...
    me->if_ngc_bil_chr~create_charc_val_desc(
      EXPORTING
