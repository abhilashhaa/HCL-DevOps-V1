  method DELETE_CHARACTERISTICVAL.
    ...
    DATA(lv_batch_request) = th_mmim_odata_request_builder=>start_request(
      ...
      )->set_uri( iv_uri = |A_ClfnCharcValueForKeyDate(CharcInternalID='{ iv_charcinternalid }',CharcValuePositionNumber='{ iv_charcvaluepositionnumber }')|
