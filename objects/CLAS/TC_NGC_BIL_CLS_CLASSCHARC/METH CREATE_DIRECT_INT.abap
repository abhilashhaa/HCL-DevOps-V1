...
*--------------------------------------------------------------------*
    ...
    DATA(lt_class_charc) = VALUE if_ngc_bil_cls_c=>lty_clfnclasscharctp-t_create_direct(
...
*--------------------------------------------------------------------*
    ...
    mo_cut->if_ngc_bil_cls~create_class_charc_direct(
      EXPORTING
