...
*--------------------------------------------------------------------*
    ...
    DATA(lt_result) = VALUE if_ngc_bil_clf=>ts_obj-read_by-_objectcharc-t_result( ( ) ).
    DATA(lt_link)   = VALUE if_ngc_bil_clf=>ts_obj-read_by-_objectcharc-t_link( ( ) ).
